...
/******/ 	var hotCurrentHash = "37cd512db4a03ae9e569"; // eslint-disable-line no-unused-vars
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _backbone = __webpack_require__(298);
	...
	var _traveler = __webpack_require__(301);

	var _traveler2 = _interopRequireDefault(_traveler);

	var _traveler_list = __webpack_require__(302);

	var _traveler_list2 = _interopRequireDefault(_traveler_list);

	var _traveler_view = __webpack_require__(303);

	var _traveler_view2 = _interopRequireDefault(_traveler_view);

	var _traveler_list_view = __webpack_require__(304);

	var _traveler_list_view2 = _interopRequireDefault(_traveler_list_view);

	var _login = __webpack_require__(305);

	var _login2 = _interopRequireDefault(_login);

	var _login_view = __webpack_require__(306);

	var _login_view2 = _interopRequireDefault(_login_view);

	var _signup_view = __webpack_require__(313);

	var _signup_view2 = _interopRequireDefault(_signup_view);
	...
	var traveler = new _traveler2.default();
	...
	var AppView = _backbone2.default.View.extend({
	  ...
	  // Initialise map
	  //--------------------------------------
	  _initialize_map: function _initialize_map() {
	    var center = new google.maps.LatLng(20.397, -5.644);
	    var styles = [{
	      elementType: "geometry",
	      stylers: [{ lightness: 33 }, { saturation: -90 }]
	    }];
	  ...
	  initialize: function initialize() {
	    ...
	    self.map_controls = (0, _jquery2.default)('#map_controls');
	    self.show_map = (0, _jquery2.default)('#show-map');
	    self.header = (0, _jquery2.default)('header');
	...
	(0, _jquery2.default)(document).ready(function () {
	  ...
	  // Signup Form
	  var signupView = new _signup_view2.default({
	    model: traveler,
	    template: _underscore2.default.template((0, _jquery2.default)('#sign-up-template').html()),
	    el: 'body'
	  });
	  signupView.render();

	  // Login Form
	  var loginView = new _login_view2.default({
	    model: login,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	(function(factory) {
	  ...
	  if (true) {
	    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(299), __webpack_require__(300), exports], __WEBPACK_AMD_DEFINE_RESULT__ = function(_, $, exports) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Traveler = _backbone2.default.Model.extend({
	  defaults: {
	    first_name: '',
	    last_name: '',
	    email: ''
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var TravelerList = _backbone2.default.Collection.extend({
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var TravelerView = _backbone2.default.View.extend({
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var TravelerListView = _backbone2.default.View.extend({
	  initialize: function initialize(params) {
	  ...
	  render: function render() {
	    ...
	    this.model.each(function (traveler) {
	      var travelerView = new _traveler_view2.default({
	        model: traveler,
	...
	exports.default = TravelerListView;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Login = _backbone2.default.Model.extend({});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _trip = __webpack_require__(307);

	var _trip2 = _interopRequireDefault(_trip);

	var _trip_list = __webpack_require__(308);

	var _trip_list2 = _interopRequireDefault(_trip_list);

	var _trip_list_view = __webpack_require__(309);

	var _trip_list_view2 = _interopRequireDefault(_trip_list_view);
	...
	var LoginView = _backbone2.default.View.extend({
	  ...
	  loginTraveler: function loginTraveler(event) {
	    var that = this;
	    event.preventDefault();
	    ...
	    loginTraveler.save(formDetails, {
	      success: function success(data) {
	        ...
	        var myTravelerList = new _traveler_list2.default();
	        myTravelerList.fetch({
	          headers: { 'Authorization': 'Bearer ' + localStorage.getItem("Authorization") },
	          success: function success() {
	            var myTravelerListView = new _traveler_list_view2.default({
	              model: myTravelerList,
	              template: _underscore2.default.template((0, _jquery2.default)('#welcome-traveler-template').html()),
	              el: 'header'
	            });
	        ...
	        var myTripList = new _trip_list2.default();
	        ...
	        myTripList.fetch({
	          ...
	          success: function success() {
	            ...
	            var myTripListView = new _trip_list_view2.default({
	              ...
	              model: myTripList,
	              template: _underscore2.default.template((0, _jquery2.default)('#list-trips-template').html()),
	              deetTemplate: _underscore2.default.template((0, _jquery2.default)('#trip-info-template').html()),
	              map: that.map,
	              el: 'body'
	            });
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Trip = _backbone2.default.Model.extend({
	  // defaults: {
	  //   location: '',
	  //   event_paid: false,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var TripList = _backbone2.default.Collection.extend({
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _trip_view = __webpack_require__(310);

	var _trip_view2 = _interopRequireDefault(_trip_view);
	...
	var _add_trip_form_view = __webpack_require__(311);

	var _add_trip_form_view2 = _interopRequireDefault(_add_trip_form_view);

	var _map_view = __webpack_require__(312);

	var _map_view2 = _interopRequireDefault(_map_view);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var TripListView = _backbone2.default.View.extend({
	  initialize: function initialize(params) {
	    this.map = params.map;
	    this.$("#all-login").hide();
	  ...
	  render: function render() {
	    ...
	    this.model.each(function (trip) {
	      var tripView = new _trip_view2.default({
	        model: trip,
	        template: that.template
	      });
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var travelerTrips = new _trip_list2.default();
	var AddTripFormView = _backbone2.default.View.extend({
	  initialize: function initialize(params) {
	...
	exports.default = AddTripFormView;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var MapView = _backbone2.default.View.extend({
	  initialize: function initialize(params) {
	    var self = this;
	    ...
	    var geocodeArray = [];
	    var requests = _jquery2.default.map(locations, getLocation);

	    _jquery2.default.when.apply(null, requests).then(function () {
	      for (var _len = arguments.length, location = Array(_len), _key = 0; _key < _len; _key++) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var SignupView = _backbone2.default.View.extend({
	  initialize: function initialize(params) {
	  ...
	  createTraveler: function createTraveler(event) {
	    event.preventDefault();
	    ...
	    newTraveler.save(travelerDetails, {
	      success: function success(data) {
	        ...
	        that.$("#sign-up").hide();
	        (0, _jquery2.default)("#login-alert").removeClass("callout alert-callout-border alert");
	        (0, _jquery2.default)("#login-alert").addClass("callout alert-callout-border success");
	        (0, _jquery2.default)("#login-message").html("You have successfully signed up! Please login to begin tracking your trips.");
	      },
	      error: function error(data) {
	        console.log("Traveler did not save");
	        (0, _jquery2.default)("#login-alert").removeClass("callout alert-callout-border success");
	        (0, _jquery2.default)("#login-alert").addClass("callout alert-callout-border alert");
	        (0, _jquery2.default)("#login-message").html("Sorry that email has already been taken. Please try login in or sign up with a different email.");
	      }
	    });
	  }
	});
